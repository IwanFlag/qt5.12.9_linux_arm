...
void CameraMedia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CameraMedia *_t = static_cast<CameraMedia *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject CameraMedia::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CameraMedia.data,
      qt_meta_data_CameraMedia,  qt_static_metacall, nullptr, nullptr}
};
...
void *CameraMedia::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CameraMedia.stringdata0))
        return static_cast<void*>(const_cast< CameraMedia*>(this));
