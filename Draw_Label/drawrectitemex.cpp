...
// 自定义 Item
DrawRectItemEX::DrawRectItemEX(QGraphicsItem *parent)
...
void DrawRectItemEX::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
...
void DrawRectItemEX::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void DrawRectItemEX::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    if ((event->modifiers() == Qt::AltModifier) && m_bResizing) {
        m_bResizing = false;
    } else {
